...
export function CardImage(props: CardData) {
  ...
  return (
    <div className="group w-[256px] h-[355px] hover:scale-125 scale-100 duration-100 z-[100] hover:z-[110] [perspective:1000px]">
      <div onClick={() => { if (!isFaceUp) setIsFaceUp(true) }} className={
        ...
        <div className="absolute inset-0 [backface-visibility:hidden]">
          <Image className={`duration-100 border-2 ${borderRarityColor} rounded-xl ${isFaceUp && "shadow-[0px_0px_20px_1px_rgba(0,0,0,0.3)]"} ${shadowRarityColor}`} unoptimized priority src={props.image_url} alt="" width={1024} height={768} quality={100} />
        </div>
